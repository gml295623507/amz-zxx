...
t.register = {}
t.register.title = '注册'
t.register.username = '请填写用户名'
t.register.password = '请输入密码'
t.register.checkPassword = '确认密码'
t.register.add = '还没有账号？立即注册...'
t.register.roback = '已有账户,去登录'

t.home = {}
t.home.sysInfo = {}
t.home.sysInfo.name = '系统名称'
t.home.sysInfo.nameVal = '95h 私人订制后台管理系统'
